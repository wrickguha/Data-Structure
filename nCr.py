"""
nCr
Difficulty: MediumAccuracy: 14.82%Submissions: 331K+Points: 4
...
class Solution:
    def nCr(self, n, r):
        ...
        # Initialize a DP table with size (r+1)
        dp = [0] * (r + 1)
        dp[0] = 1  # Base case: nC0 = 1
        
        for i in range(1, n + 1):
            # Compute values in reverse to avoid overwriting needed values
